...
*Fig.1 · Illutration du concept d'architecture en microservices versus architecture monolithique [source RedHat](https://www.redhat.com/fr/topics/microservices/what-are-microservices)*
