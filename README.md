...
![Img Microservices](monolithic-vs-microservices.png)
*Fig.2 · Illutration du concept d'architecture en microservices versus architecture monolithique [source RedHat](https://www.redhat.com/fr/topics/microservices/what-are-microservices)*
